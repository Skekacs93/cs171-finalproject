...
GraphVis = function(_parentElement, _data, _metaData, _eventHandler){
    ...
    this.innerheight = 180; //height of the graph
...
GraphVis.prototype.updateVis = function(){
    ...
    this.x.domain(d3.extent(time_aggregated, function(d) { return d.keys; }));
    ...
    // updates graph
    var path = this.svg.selectAll(".area-path")
       .data(this.displayData['time_aggregated'])
    ...
    path
    //   //.transition()
       .attr("d", function(d) {console.log(d); return this.area });
